...
* **Standard schema**: Base HED vocabulary used across all domains
* **Library schemas**: Specialized vocabularies for specific research areas (clinical, linguistic, etc.)
* **Multiple formats**: Available in MediaWiki, XML, JSON, and TSV formats
