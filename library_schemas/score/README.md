...
HED SCORE release 2.0.0 represents a major reorganization of HED SCORE so that it more closely aligns with the nominal SCORE standard as specified in Beniczky et al. 2013, 2017. The artifacts were moved to the HED standard schema and HED hierarchy was reorganized to better reflect the underlying concepts. The formal GitHub release of 2.0.0 includes a spreadsheet explaining how each term in HED SCORE 1.2.0 evolved in HED SCORE 2.0.0.

### SCORE references

> [1] Beniczky, S, et al. (2013).\
> *Standardized computer based organized reporting of EEG: SCORE.*\
> Epilepsia 54.6 (2013).

> [2] Beniczky, S., et al. (2017).\
